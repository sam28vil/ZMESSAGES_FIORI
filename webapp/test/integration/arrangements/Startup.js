sap.ui.define([
	"sap/ui/test/Opa5",
	"cristianofiori/cadastroclientes/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("cristianofiori.cadastroclientes.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "cristianofiori.cadastroclientes",
					async: true
				},
				hash: oOptions.hash,
