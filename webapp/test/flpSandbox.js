		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CadastrodeClientes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CadastrodeClientes-display": {
								"semanticObject": "CadastrodeClientes",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=cristianofiori.cadastroclientes",
									"url": sap.ui.require.toUrl("cristianofiori/cadastroclientes")
								}
							}
						}
					}
